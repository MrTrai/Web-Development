(function () {
    ...
    angular.module('education')
        .controller('studentsampleenglishController', studentsampleenglishController);

    function studentsampleenglishController($scope, restService, $state, $rootScope, $timeout) {
        var vm = this;
        vm.data = [];
        fetch();
