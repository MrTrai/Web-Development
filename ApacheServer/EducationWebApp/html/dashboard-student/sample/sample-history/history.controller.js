(function () {
    ...
    angular.module('education')
        .controller('studentsampleHistoryController', studentsampleHistoryController);

    function studentsampleHistoryController($scope, restService, $state, $rootScope, $timeout) {
        var vm = this;
        vm.data = [];
        fetch();
