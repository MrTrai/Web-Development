(function () {
    ...
    angular.module('education')
        .controller('studentsampleScienceController', studentsampleScienceController);

    function studentsampleScienceController($scope, restService, $state, $rootScope, $timeout) {
        var vm = this;
        vm.data = [];
        fetch();
